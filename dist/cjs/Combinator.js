...
var asFunctionPropFromProp = function asFunctionPropFromProp(obj) {
  var key = head(keys(obj));
  var func = obj[key];
...
var transformArgToFunctionIfNeeded = function transformArgToFunctionIfNeeded(defaultFn) {
  return _either(is_type_function, defaultFn, identity);
};
...
var makeCombineGroup = function makeCombineGroup(combinator) {
  return function (group) {
    return function () {
      return compose(asProp(group), combinator.apply(void 0, arguments));
    };
  };
};
var makeFreezeEnhancer = function makeFreezeEnhancer(combinator) {
  return function (enhancer) {
    return function () {
      ...
      return function () {
        return combinator.apply(void 0, args)(enhancer);
      };
    };
  };
};
...
var group = makeCombineGroup(combineObject);

exports.asEnhancedProp = asEnhancedProp;
exports.asFunctionProp = asFunctionProp;
exports.asFunctionPropFromProp = asFunctionPropFromProp;
exports.asProp = asProp;
exports.asScalarProp = asScalarProp;
exports.asScalarPropWithDefaultValue = asScalarPropWithDefaultValue;
exports.combineObject = combineObject;
exports.defaultArgTransformer = defaultArgTransformer;
exports.defaultArgsCombinator = defaultArgsCombinator;
exports.defaultCombineArgs = defaultCombineArgs;
exports.enhancedPropWithDefaultEnhancer = enhancedPropWithDefaultEnhancer;
exports.flattenArgsCombinator = flattenArgsCombinator;
exports.group = group;
exports.makeCombineGroup = makeCombineGroup;
exports.makeExpander = makeExpander;
exports.makeFreezeEnhancer = makeFreezeEnhancer;
exports.makeObjectCombinator = makeObjectCombinator;
exports.transformArgToFunctionIfNeeded = transformArgToFunctionIfNeeded;
